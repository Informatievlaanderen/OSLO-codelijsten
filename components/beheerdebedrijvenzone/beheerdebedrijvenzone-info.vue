    ...
    <vl-data-table>
      <tbody>
        ...
        <tr v-if="zone?.identificator">
          ...
          <td>
            <vl-link :href="zone.identificator">
              {{ zone.identificator }}
            </vl-link>
          </td>
        </tr>
        <tr v-if="zone?.bedrijventerrein">
          ...
          <td>
            <vl-link :href="zone.bedrijventerrein">
              {{ zone.bedrijventerreinLabel ?? zone.bedrijventerrein }}
            </vl-link>
          </td>
        </tr>
