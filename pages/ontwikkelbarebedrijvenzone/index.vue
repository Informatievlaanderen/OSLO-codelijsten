            ...
            <tbody>
              ...
              <tr v-else>
                <td colspan="3" class="vl-u-align-center">
                  <span v-if="isLoading">Ontwikkelbare bedrijvenzones inladen...</span>
                  <span v-else>Geen ontwikkelbare bedrijvenzones gevonden</span>
                </td>
              </tr>
            </tbody>
          </vl-data-table>
...
const total = ref(0)
const currentPageItems = ref<OntwikkelbareBedrijvenzoneListItem[]>([])
...
const pagedItems = (): OntwikkelbareBedrijvenzoneListItem[] => currentPageItems.value
...
useSeoHead({
  title: 'Ontwikkelbare bedrijvenzones',
  description: 'Overzicht van alle ontwikkelbare bedrijvenzones',
})
</script>
