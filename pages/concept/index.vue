  ...
  <vl-layout>
    <vl-region>
      <vl-grid mod-v-center mod-center mod-stacked>
        <vl-column width="12">
          <vl-title mod-no-space-bottom tag-name="h1">Concepten</vl-title>
        </vl-column>
          ...
          <vl-data-table>
            <thead>
              <tr>
                ...
                <th>Notatie</th>
                <th>Status</th>
                <th class="vl-u-display-flex">
                  Is in schema
                  <vl-badge
                    class="vl-u-spacer-left--xsmall"
                    v-vl-tooltip="'Meer informatie over deze kolom'"
                    icon="info"
                    tag-name="button"
                    hidden-label="Gelijk"
                    mod-xsmall
...
<script setup lang="ts" name="conceptSchemes">
