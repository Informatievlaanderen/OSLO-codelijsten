...
import { BEHEERDEBEDRIJVENZONE_BY_ID_QUERY } from '~/constants/bedrijventerrein.constants'
...
const sparqlQuery = computed(() => BEHEERDEBEDRIJVENZONE_BY_ID_QUERY(slug.value))
